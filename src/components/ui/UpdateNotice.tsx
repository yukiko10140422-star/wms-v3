...
const updates: UpdateEntry[] = [
  {
    version: '3.1',
    title: 'v3.1 — 安定性 & iPhone対応',
    items: [
      'iPhoneのノッチ・Dynamic Islandにボタンが被らなくなりました',
      '請求書プレビューに「戻る」ボタンを追加しました',
      'ログイン画面でキーボードからPIN入力できるようになりました',
      '未来の日付では提出できなくなりました（誤入力防止）',
      'ログアウト時に入力中のデータが安全にクリアされます',
      '作業者の編集でPINがリセットされるバグを修正しました',
      'アプリを開き直したときに最新データを自動取得します',
      '使い方ガイドをv3.0の内容に更新しました',
    ],
  },
  {
    version: '3.0',
    ...
    items: [
      ...
      '請求書の発行が自分のページからできます',
      'PINの変更はマイページから行えます',
      '初期PINは全員「1234」です。ログイン後にマイページから変更してください',
      'ログイン画面から管理者メニューにもアクセスできます',
    ],
  },
  {
    version: '2.3',
